...
public class GameConfig implements Serializable {
    ...
    private void loadPlantsConfig() {
        ...
        // 双发射手
        plants.put("Repeater", new PlantConfig(
                "Repeater",
                "双发射手",
                200,      // 阳光消耗
                100,      // 生命值
        ...
        // 高坚果
        plants.put("TallNut", new PlantConfig(
                "TallNut",
                "高坚果",
                125,      // 阳光消耗
                800,      // 生命值（非常高）
    ...
    private void loadZombiesConfig() {
        ...
        // 撑杆跳僵尸
        zombies.put("PoleVaultingZombie", new ZombieConfig(
                "PoleVaultingZombie",
                "撑杆跳僵尸",
                100,      // 生命值
                25,       // 攻击伤害
        ...
        // 气球僵尸
        zombies.put("BalloonZombie", new ZombieConfig(
                "BalloonZombie",
                "气球僵尸",
                100,      // 生命值
                25,       // 攻击伤害
        ...
        // 矿工僵尸
        zombies.put("DiggerZombie", new ZombieConfig(
                "DiggerZombie",
                "矿工僵尸",
                100,      // 生命值
                25,       // 攻击伤害
        ...
        // 巨人僵尸
        zombies.put("Gargantuar", new ZombieConfig(
                "Gargantuar",
                "巨人僵尸",
                1000,     // 生命值（非常高）
                50,       // 攻击伤害（高）
