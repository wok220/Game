...
public class BulletManager {
     ...
     * @param damage 伤害值
     */
    public void shootFirePea(int x, int y, int row, int damage) {
        Bullet bullet = new Bullet(x, y, row, damage, Bullet.BulletType.FIRE);
        addBullet(bullet);
    }
     ...
     * @param damage 伤害值
     */
    public void shootExplosive(int x, int y, int row, int damage) {
        Bullet bullet = new Bullet(x, y, row, damage, Bullet.BulletType.EXPLOSIVE);
        addBullet(bullet);
    }
