...
public class GameManager {
    ...
    public void update(float deltaTime) {
        ...
        // 9. 更新UI显示（阳光数量）
        if (gameScreen != null) {
            gameScreen.updateSunDisplay(currentSun);
            gameScreen.updateProgressBar(waveManager.getProgress());
        }
    }
    ...
    private void onVictory() {
        ...
        // 通知界面
        if (gameScreen != null) {
            gameScreen.onGameVictory(unlockPlant, remainingCarts);
        }
    }
